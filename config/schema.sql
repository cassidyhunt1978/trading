-- =================================================================
-- Clean Crypto Trading System - Database Schema
-- =================================================================
...
SELECT add_retention_policy('ohlcv_candles', INTERVAL '30 days', if_not_exists => TRUE);
...
-- =================================================================
-- AfterAction Reports (Post-trade analysis)
-- =================================================================
...
CREATE INDEX IF NOT EXISTS idx_afteraction_created ON afteraction_reports(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_afteraction_mode ON afteraction_reports(mode);
...
-- =================================================================
INSERT INTO portfolio_snapshots (mode, total_capital, deployed_capital, available_capital, open_positions)
VALUES ('paper', 10000, 0, 10000, 0)
